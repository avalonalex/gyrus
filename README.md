...
There is a [nineteen-lesson tutorial](docs/tutorial.md) built on the same
...
- `gyrus-tutorial` — nineteen lessons that teach BrainFuck by running it, with
...
| [The tutorial](docs/tutorial.md) | `gyrus-tutorial`: nineteen lessons in BrainFuck |
