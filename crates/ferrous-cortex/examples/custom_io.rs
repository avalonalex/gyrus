...
//!
//! This example demonstrates how to implement custom I/O for FerrousCortex,
...
fn main() -> Result<(), BfError> {
    ...
    let mut input = ferrous_cortex::io::StringIo::empty();
    ...
    let mut output = ferrous_cortex::io::StringIo::empty();
