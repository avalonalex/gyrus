//! Basic usage of FerrousCortex as a library
//!
...
use ferrous_cortex::{BfError, ExecutionConfig, interpret_with_io, io::StringIo, parse};

fn main() -> Result<(), BfError> {
    println!("=== FerrousCortex Basic Usage Example ===\n");
    ...
    let mut input = StringIo::new("Hello, FerrousCortex!");
    let mut output = StringIo::empty();
